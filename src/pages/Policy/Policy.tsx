    ...
    <>
      <div className={cx('wrapper')}>
        <div className={cx('container')}>
          ...
          <p>
            Chúng tôi thu thập và sử dụng thông tin cá nhân của bạn với mục đích phù hợp và hoàn
          ...
          <p>
            ...
            dưới các hình thức như: gởi thư ngỏ, đơn đặt hàng, thư cảm ơn, thông tin về khuyến mãi
            và hàng mới về…
          </p>
          ...
          <p>
            ...
            chúng tôi cam kết sẽ không tiết lộ thông tin cá nhân bạn ra ngoài. Chúng tôi có thể tiết
            lộ hoặc cung cấp thông tin cá nhân của bạn trong các trường hợp thật sự cần thiết như
            sau:
          </p>
          <div>(a) Khi có yêu cầu của các cơ quan pháp luật; </div>
          <div>
            (b) Trong trường hợp mà chúng tôi tin rằng điều đó sẽ giúp chúng tôi bảo vệ quyền lợi
